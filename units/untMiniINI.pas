...
begin
  ...
  FMiniINI.Add('');
  FMiniINI.Add('# SSD1306 LCD');
  FMiniINI.Add('# For a 128x32 display, set LCDColumns=20; LCDRows=2');
  FMiniINI.Add('# For a 128x64 display, set LCDColumns=20; LCDRows=4');
  ...
  FMiniINI.Add('LCDRows=2');
  FMiniINI.Add('');
  FMiniINI.Add('# GPIO Button Navigation');
  FMiniINI.Add('#  Any buttons set to 0 will be ignored');
  FMiniINI.Add('ButtonPinPrev=0');
  FMiniINI.Add('ButtonActionPrev=');
  FMiniINI.Add('ButtonPinNext=0');
  FMiniINI.Add('ButtonActionNext=');
  FMiniINI.Add('ButtonPinBack=11');
  FMiniINI.Add('ButtonActionBack=longpress');
  FMiniINI.Add('ButtonPinSelect=11');
  FMiniINI.Add('ButtonActionSelect=click');
  FMiniINI.Add('ButtonPinHome=11');
  FMiniINI.Add('ButtonActionHome=doubleclick');
  FMiniINI.Add('ButtonPinShortcut=11');
  FMiniINI.Add('# (Shortcut doesn''t have an action)');
  FMiniINI.Add('');
